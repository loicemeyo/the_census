...
const validatePayload = require('../middleware/validators/validatePayload')
const { handleSuccess, handleFailure, handleSuccessResult } = require('../middleware/helpers/responseHelper')
const LocationsRepository = require('../middleware/locations')
const formatGetLocationResponse = require('../middleware/adapters/formatGetLocationResponse')
const formatListLocationsResponse = require('../middleware/adapters/formatListLocationsResponse')
